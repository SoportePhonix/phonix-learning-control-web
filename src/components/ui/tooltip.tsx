...
>(({ className, sideOffset = 20, variant = 'top', ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        'z-50 bg-sidebar-tooltip-bg text-sidebar-tooltip-text font-light text-base rounded-lg py-2 px-4 animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95',
        {
      ...
      {...props}
    >
      <TooltipPrimitive.Arrow className="fill-sidebar-tooltip-bg" />
      {props.children}
    </TooltipPrimitive.Content>
  </TooltipPrimitive.Portal>
));
