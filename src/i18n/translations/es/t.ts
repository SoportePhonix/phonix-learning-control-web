export const t = {
  ...
  toCreateATrainingRoutePleaseFillInTheFields: 'Para crear una ruta de formación, complete los campos',
  toUpdateATrainingRouteCompleteTheFields: 'Para actualizar una ruta de formación, complete los campos',
  trainingRoutes: 'Rutas de formación',
  trainingRouteCreationFailed: 'Error en la creación de la ruta de formación',
  trainingRouteUpdateFailed: 'Error en la actualización de la ruta de formación',
  trainingRouteSuccessfullyRemoved: 'Ruta de formación eliminada exitosamente',
  trainingRouteCouldNotBeDeleted: 'No se pudo eliminar la ruta de formación',
