...
import { trainingPathwayCoursesColumns } from '@/app/(users)/trainingPathways/hooks/info/courses/courses.columns';
import { TrainingPathwayCourse } from '@/app/(users)/trainingPathways/hooks/info/courses/courses.types';
