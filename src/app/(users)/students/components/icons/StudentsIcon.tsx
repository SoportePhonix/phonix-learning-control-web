...
export const StudentsIcon = ({ className, ...props }: StudentsIconProps) => (
  <svg viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
    <path
    ...
    />
    <path
      d="M21.9386 23.0357C21.2189 20.7915 19.8051 18.8338 17.9011 17.4448C15.997 16.0559 13.7011 15.3074 11.3443 15.3074C8.98748 15.3074 6.69155 16.0559 4.78751 17.4448C2.88347 18.8338 1.4697 20.7915 0.75 23.0357H21.9386Z"
      stroke="currentColor"
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
